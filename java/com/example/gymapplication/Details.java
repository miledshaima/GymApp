...
public class Details extends AppCompatActivity {
    ...
    private static int placesDisponibles = 10; // Initial value

    private TextView textViewPlacesDisponibles;

    private boolean reservationEffectuee = false;

    public static void updatePlaces(String typeCours) {
        if ("musculaion".equals(typeCours)) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reserv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonReserver.setEnabled(false);
                buttonReserver.setBackgroundColor(ContextCompat.getColor(Details.this, R.color.grey)); // Utilisez votre propre couleur grise
                buttonReserver.setText("Déjà réservé");
        ...
        buttonAnnuler.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonReserver.setBackgroundColor(ContextCompat.getColor(Details.this, R.color.teal_200)); // Utilisez votre propre couleur
                ...
                Toast.makeText(Details.this, "Réservation annulée", Toast.LENGTH_SHORT).show();
                buttonReserver.setEnabled(true);
                reservationEffectuee = false;
            }
        });
    ...
    private void updatePlacesTextView() {
        textViewPlacesDisponibles.setText("Places disponibles : " + placesDisponibles);
    }
}