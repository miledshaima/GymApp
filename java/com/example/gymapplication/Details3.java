...
public class Details3 extends AppCompatActivity {
    ...
    public static void updatePlaces3(String typeCours) {
        if ("cross training".equals(typeCours)) {
            nbplacesDisponibles--; // Decrease places for musculaion
        }}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reserv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonReserver.setEnabled(false);
                buttonReserver.setBackgroundColor(ContextCompat.getColor(Details3.this, R.color.grey)); // Utilisez votre propre couleur grise
                buttonReserver.setText("Déjà réservé");
        ...
        buttonAnnuler.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buttonReserver.setBackgroundColor(ContextCompat.getColor(Details3.this, R.color.teal_200)); // Utilisez votre propre couleur
                buttonReserver.setText("Réserver");
                nbplacesDisponibles++; // Decrease places for musculaion
                textViewPlacesDisponibles.setText("Places disponibles : " + nbplacesDisponibles);
                // Masquer le bouton "Annuler"
                buttonAnnuler.setVisibility(View.GONE);
                // Afficher un message ou faire d'autres actions nécessaires
                Toast.makeText(Details3.this, "Réservation annulée", Toast.LENGTH_SHORT).show();
                buttonReserver.setEnabled(true);
                reservationEffectuee = false;
            }
        });
    ...
    private void updatePlacesTextView3() {
        textViewPlacesDisponibles.setText("Places disponibles : " + nbplacesDisponibles);
    }
}